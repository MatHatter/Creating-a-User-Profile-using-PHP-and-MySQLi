...
<form action="../../Templates/components/update-profile.php" method="post" enctype="multipart/form-data" id="UploadForm">
    <!-- Nav tabs -->  
    ...
    <!--<div class="submit">
        <center>
        <!--<input type="hidden" name="MM_insert" value="Save_Button" />-->
